...
using Soenneker.N8n.OpenApiClient.Credentials.Item;
using Soenneker.N8n.OpenApiClient.Credentials.Schema;
...
using System;
namespace Soenneker.N8n.OpenApiClient.Credentials
{
    /// <summary>
    ...
    public partial class CredentialsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.N8n.OpenApiClient.Credentials.Schema.SchemaRequestBuilder Schema
        {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.CreateCredentialResponse?> PostAsync(global::Soenneker.N8n.OpenApiClient.Models.Credential body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.CreateCredentialResponse> PostAsync(global::Soenneker.N8n.OpenApiClient.Models.Credential body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder.CredentialsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder.CredentialsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.N8n.OpenApiClient.Models.Credential body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.N8n.OpenApiClient.Models.Credential body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.N8n.OpenApiClient.Credentials.CredentialsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve all credentials from your instance. Only available for the instance owner and admin. Credential data (secrets) is not included.
        /// </summary>
