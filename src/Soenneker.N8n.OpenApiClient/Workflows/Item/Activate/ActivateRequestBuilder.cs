...
#nullable enable
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.Workflow?> PostAsync(global::Soenneker.N8n.OpenApiClient.Models.PostWorkflowsIdActivate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.Workflow> PostAsync(global::Soenneker.N8n.OpenApiClient.Models.PostWorkflowsIdActivate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.N8n.OpenApiClient.Models.PostWorkflowsIdActivate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.N8n.OpenApiClient.Models.PostWorkflowsIdActivate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
