...
namespace Soenneker.N8n.OpenApiClient.Workflows.Item.Unarchive
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.N8n.OpenApiClient.Workflows.Item.Unarchive.UnarchiveRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.WorkflowPublicDtoGenerated?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.N8n.OpenApiClient.Models.WorkflowPublicDtoGenerated> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.N8n.OpenApiClient.Workflows.Item.Unarchive.UnarchiveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.N8n.OpenApiClient.Workflows.Item.Unarchive.UnarchiveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.N8n.OpenApiClient.Workflows.Item.Unarchive.UnarchiveRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
